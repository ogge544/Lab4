...
public class GomokuGameState extends Observable implements Observer{
   ...
   // Game variables
	...
	public void move(int x, int y){
		/*
		 * 1: Make sure a game is going on!
		 * 2: Make sure it's me's turn
		 * 3: the square is "free" 
		 */
		if(currentState == NOT_STARTED) {
			...
			//The chosen square was not clear.
			}else {
				message = "The square is not clear, pleas try again!";
				setChangedNotify();
			}
